defmodule ScdbWeb.RunLiveTest do
  ...
  @create_attrs %{captain: "some captain", cscu: 42, location: "some location", miners: [], paid_out: true, refinery: :test_refinery, refinery_cost: 42, refining_time: "some refining_time", run_time: 42, sell_price: 42, sold: true}
